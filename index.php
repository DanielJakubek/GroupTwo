...
/* Uses a semi-transparent img instead of using opacity */
#carouselArea{
background-image: url('Images/sliderArea.png');
padding: 100px;
...
padding-bottom: 10px;
  ...
  <body>
    ...
    <content>
      <div class="bg-image">
        <div class="container-flex" id="intermissionArea">
          <h1> Dundee [Make this look better, bottom lef?] </h1>
        </div>
